...
#+begin_src python :results output
  ...
  print("the predect of 3 ele is {}".format(np.dot(np.c_[np.arange(testsize), np.arange(testsize),np.ones(testsize)], weight)))
...
: OLS : the weight is[1.00005041 2.00010081], and the bais is 21.587524752475453 
: the predect of 3 ele is [21.58752475 24.58767597 27.58782718 30.5879784  33.58812961]
...
: prepera data
: the X shape is (100, 3), and y shape is (100,)
: Sklearn: the weith is [1.00045125 2.00090249], and the intercept is 21.4483168316832
: the predect of 3 ele is [21.44831683 24.44967057 27.4510243  30.45237804 33.45373177]
...
: prepera data
: the X shape is (100, 3), and y shape is (100,)
: Greadient decent: the weight is [1.00017775 2.0003555 ], and the intercept is 21.51579385880701
: the predect of 3 ele is [21.51579386 24.51632711 27.51686036 30.51739361 33.51792685]

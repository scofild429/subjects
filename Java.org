...
download : https://introcs.cs.princeton.edu/java/stdlib/
...
* java Settings
** execute in Emacs for separate packages
#+BEGIN_SRC 
...
|-------------------------+--------------------------------|
| Toggle sticky Selection | 设置快捷键来设定开始mark的位置 |
|                         |                                |
...
| Ctrl  k | yank                   | yank                         |
| Ctrl  y | paste                  | 粘贴                         |
| Ctrl  a | active options         | 打开可用功能，例如创建新方法 |
|         |                        |                              |
...
| Alt  Enter | Generate/New  | 生成/新建            |
| Alt  ;     | comment       | 注释行(单行不必选中) |
| Alt  .     | go to define  | 查看定义             |
| Alt  w     | cope          | 复制                   |
...
** Ctrl Alt 
|------------------+--------------------------------+------------------|
| Ctrl  Alt  ,     | close the main menu bar        | 关闭menu bar     |
| Ctrl  Alt  f     | Full screen mode               | 全屏             |
| Ctrl  Alt  m     | main menu                      | 关闭main menu    |
...
| Ctrl  Alt  p     | new file                       | 新建文件         |
| Ctrl  Alt  b     | open Tool windows bar function | 打开周围的功能   |
| Ctrl  Alt  v     | .var                           | 类型赋值         |
| Ctrl  Alt  l     | reformat region                | 格式化文件块     |
| Ctrl  Alt  i     | go to Implement                | 去实现类         |
|                  |                                |                  |
